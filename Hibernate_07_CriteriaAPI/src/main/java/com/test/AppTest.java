...
public class AppTest {
	...
	public static void main(String[] args) {
		...
		criteria.add(Restrictions.eq("studentName", "Akash"));
		...
		crit1.add(Restrictions.ne("studentName", "Akash"));
		 ...
		 * 
		 * Criteria crit8 = session.createCriteria(Student.class); Projection
		 * projection1 = Projections.max("rollNumber"); Projection projection2 =
		 * Projections.property("studentName");
		 * 
		 * 
		 * ProjectionList pList = Projections.projectionList(); pList.add(projection1);
		 * pList.add(projection2); crit8.setProjection(pList);
		 * 
		 * List list2 = crit8.list();
		 * 
		 * Iterator it2 = list2.iterator(); while (it2.hasNext()) { Object[] obj =
		 * (Object[]) it2.next(); System.out.println("Roll No : " +
		 * obj[0]+" Name : "+obj[1]); }
		 */
